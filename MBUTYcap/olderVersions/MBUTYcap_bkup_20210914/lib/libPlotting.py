...
class plottingEvents():
    ...
    def __init__(self, events, allAxis):
        ...
        self.selectCoinc = events.positionS >= 0
    ...
    def plotXYToF(self, logScale = False, absUnits = False):
        ...
        if absUnits == False:
            ...
            h2D, hProj, hToF = hh.histog().histXYZ(self.allAxis.axWires.axis, self.events.positionW[self.selectCoinc], self.allAxis.axStrips.axis, self.events.positionS[self.selectCoinc], self.allAxis.axToF.axis, self.events.ToF[self.selectCoinc],coincidence=True,showStats=True)
            ...
            ax2.step(self.allAxis.axWires.axis,hProj,'b',where='mid',label='2D')
            if logScale is True:
               ax2.set_yscale('log')
            ...
            h2D, hProj, hToF = hh.histog().histXYZ(self.allAxis.axWires_mm.axis, self.events.positionWmm[self.selectCoinc], self.allAxis.axStrips_mm.axis, self.events.positionSmm[self.selectCoinc], self.allAxis.axToF.axis, self.events.ToF[self.selectCoinc],coincidence=True,showStats=True)
            ...
            ax2.step(self.allAxis.axWires_mm.axis,hProj,'b',where='mid',label='2D')
            if logScale is True:
               ax2.set_yscale('log')
    ...
    def plotXLambda(self, logScale=False, absUnits = False):
        ...
        if absUnits is False:
            h = hh.histog().hist2D(self.allAxis.axLambda.axis, self.events.wavelength[self.selectCoinc], self.allAxis.axWires.axis , self.events.positionW[self.selectCoinc])
            ...
            h = hh.histog().hist2D(self.allAxis.axLambda.axis, self.events.wavelength[self.selectCoinc], self.allAxis.axWires_mm.axis , self.events.positionWmm[self.selectCoinc])
