...
###############################################################################
###############################################################################
########    V1.3 2021/09/23      francescopiscitelli     ######################
###############################################################################
###############################################################################
...
for fileName in fileDialogue.fileName:
    ...
    ### load data  
    pcap = pcapr.pcapng_reader(fileDialogue.filePath+fileName, parameters.clockTicks.NSperClockTick, sortByTimeStampsONOFF = True)
